# ToolCase v5.4.1 publiceren op GitHub
...
git commit -m "release: ToolCase v5.4.1"
```
...
Maak daarna op GitHub een release vanaf tag `v5.4.1` en gebruik de sectie
`5.4.1` uit `CHANGELOG.md` als release notes.
